...
namespace Acadon.Controllers
{
    ...
    public class PredmetController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Naziv,NastavnikID")] Predmet predmet)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Naziv,NastavnikID")] Predmet predmet)
        {
            if (id != predmet.ID)
            {
                return NotFound();
